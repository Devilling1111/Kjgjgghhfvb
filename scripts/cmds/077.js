        ...
        onStart: async function ({ message, args, event, threadsData, getLang, role }) {
                ...
                if (!command && !args[0] || !isNaN(args[0])) {
                        ...
                        if (sortHelp == "name") {
                                ...
                                msg += (returnArray || []).reduce((text, item, index) => text += `│━─━──━─━≪ᥬ😳᭄𝐁𝟒𝐃𝟗𝐋ᥬ😱᭄≫━──━─━─━❯❯\n│${index + startNumber}${index + startNumber < 10 ? " " : ""}.${item.data}\n`, '').slice(0, -1);
                ...
                // ————————————————— INFO COMMAND ————————————————— //
                        ...
                        return message.reply({body:formSendMessage,attachment: await global.utils.getStreamFromURL("https://i.imgur.com/9MyA1TI.jpeg")})
                }
        }
};
