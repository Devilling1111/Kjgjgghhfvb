        ...
        onStart: async function ({ message, args, event, threadsData, getLang, role }) {
                ...
                if (!command && !args[0] || !isNaN(args[0])) {
                        ...
                        if (sortHelp == "name") {
                                ...
                                await message.reply({ body: getLang("help", msg, page, totalPage, commands.size, prefix, doNotDelete), attachment: await global.utils.getStreamFromURL("https://i.imgur.com/Jibiw6L.jpeg"});
                        }
