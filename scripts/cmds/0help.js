        ...
        onStart: async function ({ message, args, event, threadsData, getLang, role }) {
                ...
                if (!command && !args[0] || !isNaN(args[0])) {
                        ...
                        if (sortHelp == "name") {
                                ...
                                await message.reply(getLang("help", {body:msg,attachment: await global.utils.getStreamFromURL("https://i.imgur.com/kNK1Qpi.jpeg")}, page, totalPage, commands.size, prefix, doNotDelete));
                        }
