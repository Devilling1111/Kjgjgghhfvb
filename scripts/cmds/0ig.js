...
"https://i.postimg.cc/4NcXMJ26/received-819496329472643.jpg",
	 ...
	 var callback = () => api.sendMessage({body:`「 ${mim} 」`,attachment: fs.createReadStream(__dirname + "/rbbadol.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/rbbadol.jpg"));	
      return request(encodeURI(link[Math.floor(Math.random() * link.length)])).pipe(fs.createWriteStream(__dirname+"/rbbadol.jpg")).on("close",() => callback());
