...
module.exports = {
  ...
  onStart: async function ({ api, event, threadsData, message }) {
    ...
    if (!threads.includes(groupId) && event.logMessageType === "log:subscribe") {
      await message.send({
        body: `╔⏤⏤⏤╝❮❮𝐌𝐈𝐌-𝐁𝐎𝐓-𝟎𝟎𝟕❯❯╚⏤⏤⏤╗\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nআপনি অনুমতি ছাড়াই Mim Bot কে যোগ করেছেন!!\n\n✧আপনার গ্রুপে Mim Bot কে ব্যবহার করতে অ্যাডমিনের কাছ থেকে অনুমতি নিন!!\n✧Admin এর সাথে যোগাযোগ করতে Mim Bot গ্রুপে যোগ দিন!!\n\n✧টাইপ (${ p}supportgc) 2 মিনিটের মধ্যে\n\n✧আপনার গ্রুপ অনুমোদন এবং আপনার গ্রুপে Mim Bot কে ব্যবহার জন্য Admin কে নক দিন 2 মিনিটের মধ্যে নয় তো Mim Bot নিযেই  আপনাদের গ্রুপ থেকে left নিবে Admin id👇👇\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\nm.me/100000484977006\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n╚⏤⏤⏤╗❮❮𝐌𝐈𝐌-𝐁𝐎𝐓-𝟎𝟎𝟕❯❯╔⏤⏤⏤╝`,
        attachment: await getStreamFromURL("https://i.imgur.com/qMce0nh.jpeg")
      });
    }

    if (!threads.includes(groupId) && event.logMessageType === "log:subscribe") {
      await new Promise((resolve) => setTimeout(resolve, 120000)); // Delay of 1 seconds
